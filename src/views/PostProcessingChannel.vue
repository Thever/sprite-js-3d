<template>
  <div class="about">
    <p>3D扩展允许给layer设置一个后期处理通道，所谓后期处理通道，是指将renderer输出的内容放到FrameBuffer中依次通过若干个后期处理的Program来完成渲染。</p>
    <div id="stage"></div>
  </div>
</template>
<script>
...
export default {
  ...
  methods: {
    init() {
      ...
      //  导入渲染对象，3d网格，几何体，立方体，着色器
      const { RenderTarget, Mesh3d, Geometry, Cube, shaders } = spriteExtend3d;
      //  渲染容器
